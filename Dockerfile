...
RUN New-LocalUser -Name '"RDP"' -Password "RDP" -AccountNeverExpires -Description '"RDP User"' -FullName '"RDP"' -UserMayNotChangePassword && Add-LocalGroupMember -Group "Administrators" -Member "RDP"
